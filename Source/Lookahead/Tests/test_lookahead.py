...
card2string = CardToString()
current_node['board'] = card2string.string_to_board('Ks')
current_node['street'] = 2
current_node['current_player'] = constants['players']['P1']
current_node['bets'] = np.array([100,100])

cardtool = card_tool.CardTool()

player_range = cardtool.get_random_range(current_node['board'], 2)
opponent_range = cardtool.get_random_range(current_node['board'],4)
'''
